...
$_['text_greeting'] = 'Felicitaciones, ha recibido un certificado de regalo por valor de %s';
$_['text_from'] = 'Este certificado de regalo le ha sido enviado por %s';
$_['text_message'] = 'Con un mensaje que dice';
$_['text_redeem'] = 'Para canjear este Certificado de regalo, escriba el código de canje que es <b> %s </b> y luego haga clic en el enlace a continuación y compre el producto en el que desea usar este certificado de regalo. Puede ingresar el código del certificado de regalo en la página del carrito de compras antes de hacer clic en pagar. ';
